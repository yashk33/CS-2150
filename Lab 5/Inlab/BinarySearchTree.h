...
private:
    ...
    bool find(const string& x, BinaryNode* node) const;

    string pathTo(const string& x, BinaryNode* node, string path) const;

    void insert(const string& x, BinaryNode*& node) const;
};
