...
private:
    ...
    void balance(AVLNode*& n) const;
    // rotateLeft performs a single rotation on node n with its right child.
    AVLNode* rotateLeft(AVLNode*& n) const;
    // rotateRight performs a single rotation on node n with its left child.
    AVLNode* rotateRight(AVLNode*& n) const;
    ...
    bool find(const string& x, AVLNode* node) const;

    string pathTo(const string& x, AVLNode* node, string path) const;

    AVLNode* insert(const string& x, AVLNode*& node) const;
};
